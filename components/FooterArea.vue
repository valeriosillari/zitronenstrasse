      ...
      .row.align-items-center
        ...
        .col-sm-4.col-right
          ...
          ul.item-icons
            ...
            //- FB
            li.item-icon
              a.icon.facebook(href='https://www.facebook.com/zitronenstrasse/', title='Zitronenstrasse on Facebook', target='_blank')
                | fb
            ...
            //- Twitter
            li.item-icon
              a.icon.twitter(href='https://twitter.com/zitronenstrasse' title='Zitronenstrasse on Twitter', target='_blank')
                | tw
                //- svg.svg(viewbox='0 0 512 512')
            ...
            //- Github
            li.item-icon
              a.icon.github(href='https://github.com/valeriosillari/zitronenstrasse' title='Zitronenstrasse on Github', target='_blank')
                | git
                //- svg.svg(viewbox='0 0 512 512')
